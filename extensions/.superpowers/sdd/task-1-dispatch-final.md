You are implementing Task 1: Create Extension Scaffold with Config Loading

## Task Description

Read your task brief first: `C:/GitLocal/pi-utilities/.superpowers/sdd/task-1-brief.md`
...
Work from: `C:/GitLocal/pi-utilities/extensions`
...
Write your full report to `C:/GitLocal/pi-utilities/.superpowers/sdd/task-1-report.md`:
